...
function Editpost()
{
    ...
    const handleSubmit = async (e) => {
        ...
        const formaData = {id:id, title:formvalue.title, descr:formvalue.descr, img:formvalue.img, category:formvalue.category, price:formvalue.price};
            ...
            <div className='container'>
                <div className='row'>
                    ...
                    <div className="mb-3 row">
                        ...
                        <div className="col-sm-10">
                        <input type="number" min="0" max="999" className="form-control pb-5" id="price" name="price"value={formvalue.price} onChange={handleInput}/>
                        </div>
                    </div>
                    <div className="mb-3 row">
